...
import {services} from '../cosntants'
...
const ServiceCard=({index,title,icon})=>{
  return(
    <Tilt className='xs:w-[250px] w-full'>
      <motion.div className='w-full green-pink-gradient 
      p-[1px] rounded-[20px] shadow-card' variants={fadeIn('right','spring',0.5*index,0.75)}>
<div options={{
...
const About = () => {
  return (
    ...
    variants={fadeIn("","",0.1,1)}>
      ...
      solutions that solves the real-world problems.Let`s work together
